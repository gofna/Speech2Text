...
testLocation = 'df.5.csv'
modelLocation = 'models/wav2letter/final.pth'

parser = argparse.ArgumentParser(description='Wav2Letter evaluation')
parser.add_argument('--test-manifest',metavar='DIR',help='path to test manifest csv', default=testLocation)
...
parser.add_argument('--model-path',type=str, default=modelLocation,help='Path to model.tar to evaluate')
